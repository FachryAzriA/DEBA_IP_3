...
public class Kel3Tgs3
{
    public static void main(String[] args) {
        ...
        String[] arr_AnswerWord_lvl1 = {"die","led","lei","let","lid","lie"
                                        ,"lit","tie","deli","diet","edit","tilt"
                                        ,"idle","lied","tide","tied","tile"
    ...
    public static class CoepoeLvl_Class {
        ...
        // function level 1
        public int CoepoeLvl1(int p_scores_lvl1, String[] p_input_array_lvl1, String[] p_answer_word_lvl1) throws IOException {
